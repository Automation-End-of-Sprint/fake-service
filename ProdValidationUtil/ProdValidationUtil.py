...
def createFilePath(serviceList):
    for service in serviceList:
        if service.environmentType == Constants.EnvironmentType.NA:
            ...
            filePath = Path(
                "./TestDocs/Develop/" + service.serviceName + "/" + service.serviceName + "-" + service.environmentType.value + ".properties")
            service.setFilePath(filePath)
        elif service.environmentType == Constants.ValidationEnvConstants.DEVELOPBaseProperties:
            filePath = Path("./TestDocs/Develop/" + service.serviceName + "/" + service.serviceName + ".properties")
            service.setFilePath(filePath)
        elif service.environmentType == Constants.ValidationEnvConstants.MASTERBaseProperties:
            filePath = Path("./TestDocs/Master/" + service.serviceName + "/" + service.serviceName + ".properties")
            service.setFilePath(filePath)
            ...
            filePath = Path(
                "./TestDocs/Master/" + service.serviceName + "/" + service.serviceName + "-" + service.environmentType.value + ".properties")
            service.setFilePath(filePath)
        else:
            filePath = Path(
                "./TestDocs/Develop/" + service.serviceName + "/" + service.serviceName + "-" + service.environmentType.value + ".properties")
